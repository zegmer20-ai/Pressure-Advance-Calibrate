...
var pa_step=0.05             ; Указать шаг изменения коэффициента Pressure Advance
var pa_number=10              ; Указать количество тестовых линий

var acceleration=1000         ; Указать ускорение для осей X и Y
...
var extrusion_multiplier=4,65 ; Указать коэффициент экструзии

var retract_length=0.4       ; Указать длину ретракта, мм
...
var fast_speed=80             ; Указать быструю скорость печати тестовых линий, мм/сек
